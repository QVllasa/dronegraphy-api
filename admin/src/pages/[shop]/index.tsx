...
export default function ShopPage() {
    ...
    return (
        <div className="grid grid-cols-12 gap-6">
            ...
            <div className="order-2 col-span-12 sm:col-span-6 xl:order-1 xl:col-span-4 3xl:col-span-3">
                <div className="flex flex-col items-center rounded bg-white py-8 px-6">
                    <div className="relative mb-5 h-36 w-36 rounded-full">
                        <div
                            className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-full border border-gray-100">
                            <Image
            ...
            {/* Cover Photo */}
            <div
                className="relative order-1 col-span-12 h-full min-h-[400px] overflow-hidden rounded bg-light xl:order-2 xl:col-span-8 3xl:col-span-9">
                <Image
                ...
                <div className="grid h-full grid-cols-1 gap-5 rounded bg-light p-4 md:grid-cols-3">
                    <div className="space-y-3">
                        ...
                        <div className="border border-gray-100">
                            <div className="flex items-center border-b border-gray-100 py-3 px-4">
                                <div
                                    className="flex h-11 w-11 items-center justify-center rounded-full bg-[#FC9EC6] p-3 text-light">
                                    <CubeIcon width={18}/>
                                </div>
                            ...
                            <div className="flex items-center py-3 px-4">
                                <div
                                    className="flex h-11 w-11 items-center justify-center rounded-full bg-[#6EBBFD] p-3 text-light">
                                    <OrdersIcon width={16}/>
                                </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="border border-gray-100">
                            <div className="flex items-center border-b border-gray-100 py-3 px-4">
                                <div
                                    className="flex h-11 w-11 items-center justify-center rounded-full bg-[#C7AF99] p-3 text-light">
                            ...
                            <div className="flex items-center py-3 px-4">
                                <div
                                    className="flex h-11 w-11 items-center justify-center rounded-full bg-[#FFA7AE] p-3 text-light">
                                    <DollarIcon width={12}/>
                                </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="border border-gray-100">
                            <div className="flex items-center border-b border-gray-100 py-3 px-4">
                                <div
                                    className="flex h-11 w-11 items-center justify-center rounded-full bg-[#D59066] p-3 text-light">
